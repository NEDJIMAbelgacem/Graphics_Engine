...
class CameraController_3D : public Layer {
public:
    Camera_3D& camera;
    ...
    float mouse_move_sensitivity = 2000.0f;

    bool button_pressed = false;
public:
	CameraController_3D(Camera_3D& _camera) : Layer("Camera layer"), camera(_camera) { }
    ...
    bool OnMouseMoved(MouseMovedEvent& e) {
        ...
        //     // camera->ProcessMouseMove(e.GetX() - mouse_x, e.GetY() - mouse_y, Application::delta_time);
        // }
	...
	void OnEvent(Event& event) override {
        ...
        dispatcher.Dispatch<KeyPressedEvent>(BIND_EVENT_FN(CameraController_3D::OnKeyPressed));
        dispatcher.Dispatch<MouseMovedEvent>(BIND_EVENT_FN(CameraController_3D::OnMouseMoved));
        dispatcher.Dispatch<MouseScrolledEvent>(BIND_EVENT_FN(CameraController_3D::OnMouseScrolled));
        dispatcher.Dispatch<MouseButtonPressedEvent>(BIND_EVENT_FN(CameraController_3D::OnMouseButtonPressed));
        dispatcher.Dispatch<MouseButtonReleasedEvent>(BIND_EVENT_FN(CameraController_3D::OnMouseButtonReleased));
	}
};
