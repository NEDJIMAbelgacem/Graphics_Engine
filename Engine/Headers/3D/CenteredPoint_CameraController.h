...
class CenteredPoint_CameraController : public Layer {
public:
    Camera_3D& camera;
...
public:
	CenteredPoint_CameraController(Camera_3D& _camera) : Layer("Camera layer"), camera(_camera) { }
    ...
    bool OnMouseMoved(MouseMovedEvent& e) {
        ...
        //     camera.SetFront(glm::normalize(-camera.GetPosition()));
        // }
	...
	void OnEvent(Event& event) override {
        ...
        dispatcher.Dispatch<KeyPressedEvent>(BIND_EVENT_FN(CenteredPoint_CameraController::OnKeyPressed));
        dispatcher.Dispatch<MouseMovedEvent>(BIND_EVENT_FN(CenteredPoint_CameraController::OnMouseMoved));
        dispatcher.Dispatch<MouseScrolledEvent>(BIND_EVENT_FN(CenteredPoint_CameraController::OnMouseScrolled));
        dispatcher.Dispatch<MouseButtonPressedEvent>(BIND_EVENT_FN(CenteredPoint_CameraController::OnMouseButtonPressed));
        dispatcher.Dispatch<MouseButtonReleasedEvent>(BIND_EVENT_FN(CenteredPoint_CameraController::OnMouseButtonReleased));
	}
};
