...
protected:
    Texture* texture;
public:
    TexturedSphere(std::string texture_path, glm::vec3 _position, float _radius, glm::vec3 _rotation = glm::vec3(0.0f), int nb_triangles = 50) 
        : Sphere(_position, _radius, glm::vec3(1.0f, 0.0f, 0.0f), _rotation, nb_triangles) {
